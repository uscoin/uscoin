#############################################################################
# Makefile for building: usacoin-qt
# Generated by qmake (2.01a) (Qt 4.8.4) on: ?? ?? 9 19:44:26 2013
# Project:  usacoin-qt.pro
# Template: app
# Command: d:\Qt-mgw\4.8.4\bin\qmake.exe USE_UPNP=- -o Makefile usacoin-qt.pro
#############################################################################
...
Makefile: usacoin-qt.pro  d:/Qt-mgw/4.8.4/mkspecs/win32-g++/qmake.conf d:/Qt-mgw/4.8.4/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_UPNP=- -o Makefile usacoin-qt.pro
